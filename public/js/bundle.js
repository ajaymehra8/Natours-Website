...
var displayMap = exports.displayMap = function displayMap(locations) {
  var map = new maplibregl.Map({
    container: 'map',
    // container id
    style: 'https://api.maptiler.com/maps/bright-v2/style.json?key=RRICEqeuyMelVlPwmriL',
    // style URL
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alerts.showAlert)('error', 'Problem in login.');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Problem in logging out! Try again.');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Check your email for otp');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          } else {
        ...
        case 9:
          _context.prev = 9;
          _context.t0 = _context["catch"](1);
          (0, _alerts.showAlert)('error', 'Problem in signup');
...
},{"./alerts.js":"alerts.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
},{"./alerts.js":"alerts.js"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51PN6woLGRnAugSG1CF3gAkjRj0IAuFPD6JoyuOn9vdG2moEG163xYBXNeiEwFEKWH1AFPt08ojD8x06jHDk5obuS00pW8V7rJ5');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var currentPassword, updatedPassword, passwordConfirm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          updatedPassword = document.getElementById('password').value;
